...
const PrivacyScoreDisplay = ({
  ...
  const privacyScore = Math.min(
    100,
    Math.round(privateBalanceScore + burnerScore + baseScore)
  );
  ...
  return (
    <div
      className={`p-4 rounded-xl border ${privacyLevel.bg} ${privacyLevel.border}`}
    >
      ...
      <div className="mb-3">
        <div className="w-full h-2 bg-white/5 rounded-full overflow-hidden">
          <div
            className={`h-full ${privacyLevel.bg.replace(
              "/20",
              ""
